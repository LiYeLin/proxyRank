...
def evaluate_merchants(speed_tests_df_input, merchants_df_input, weights=None):
    # 使用传入的数据
    speed_tests_df = speed_tests_df_input.copy()
    merchants_df = merchants_df_input.copy()
